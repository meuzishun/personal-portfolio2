...
var setMobileHeight = function setMobileHeight() {
  var styleSheet = document.querySelector(':root');
  var vh = window.innerHeight * 0.01;
  styleSheet.style.setProperty('--vh', "".concat(vh, "px"));
};
